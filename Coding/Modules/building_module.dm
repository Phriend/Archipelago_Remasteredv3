...
#define COMPONENTS_WELL	list(/obj/item/material/Bricks,/obj/item/material/Bricks,/obj/item/material/Bricks,/obj/item/material/Bricks,/obj/item/material/Logs,/obj/item/misc/Mortar,/obj/item/misc/Rope)
...
#define COMPONENTS_BRICK_TORCH list(/obj/item/material/Bricks,/obj/item/misc/Nails,/obj/item/misc/Torch,/obj/item/misc/Mortar)
#define COMPONENTS_STONE_TORCH list(/obj/item/material/Stone_Block,/obj/item/material/Stone_Block,/obj/item/material/Stone_Block,/obj/item/material/Stone_Block,/obj/item/misc/Nails,/obj/item/misc/Torch,/obj/item/misc/Mortar)
...
datum/buildingInfo
	...
	woodChest
		...
		name = "Wooden Chest"
	dock
		objType = /obj/building/floor/Dock
		components = COMPONENTS_TWO_LOG_NAIL
		skill = 4
		name = "Dock"
	woodTable
	...
	brickFurnace
		...
		name = "Brick Furnace"
	brickDoor
		objType = /obj/building/door/Brick_Door
		name = "Brick Door"
		components = COMPONENTS_BRICKS
		material = TYPE_BRICK
		skill = 5
	brickFloor
		objType = /obj/building/floor/Brick_Floor
		name = "Brick Floor"
		components = COMPONENTS_BRICKS
		material = TYPE_BRICK
		skill = 5
	brickWindow
		objType = /obj/building/window/Brick_Windowed_Wall
		name = "Birck Window"
		components = COMPONENTS_BRICKS
		material = TYPE_BRICK
		skill = 6
	brickTorch
		objType = /obj/building/torch/Brick_Wall_Torch
		name = "Brick Wall with Torch"
		components = COMPONENTS_BRICK_TORCH
		material = TYPE_BRICK
		skill = 6
	...
	stoneDoor
		...
		skill = 5
	stoneFloor
		objType = /obj/building/floor/Stone_Floor
		name = "Stone Floor"
		components = COMPONENTS_FOUR_STONE
		material = TYPE_STONE
		skill = 3
	stoneFloorD
		objType = /obj/building/floor/Stone_FloorD
		name = "Stone FloorD"
		components = COMPONENTS_FOUR_STONE
		material = TYPE_STONE
		skill = 4
	stoneWindow
		objType = /obj/building/window/Stone_Windowed_Wall
		name = "Stone Window"
		components = COMPONENTS_SIX_STONE
		material = TYPE_STONE
		skill = 6
	stoneTorch
		objType = /obj/building/torch/Stone_Wall_Torch
		name = "Stone Wall with Torch"
		components = COMPONENTS_STONE_TORCH
		material = TYPE_STONE
		skill = 6
	...
	player // To make roofs visable by default
		...
		proc
			...
			TryBuild(BuildingName,turf/location,obj/item/material/buildMaterial)
				...
				if ( location.density )
					if(istype(location,/turf/Water) & istype(BI.objType,/obj/building/floor/Dock))
					else
			...
			Build(datum/buildingInfo/BI,turf/location,usedMaterials)
				...
				if ( prob(BI.getChance(src) ) )
					...
					if ( usr.health <= 0 )
						usr:Die("was crushed by a falling building.")
