	...
	GetComboType(obj/item/obj1,obj/item/obj2,SecondTry = 0)
		...
		switch (obj1.type)
			...
			if ( /obj/item/fertilizer/Vegetable_Matter )
				if ( istype(obj2,/obj/item/fertilizer/Vegetable_Matter) )	return /obj/Compost
			...
			if ( /obj/item/misc/Rock )
				switch (obj2.type)
					...
					if ( /obj/item/misc/Mortar )	return /obj/item/tool/Mortar_And_Pestle
			...
			if ( /obj/item/misc/Bundle_Of_Vines )
				switch (obj2.type)
					if ( /obj/item/misc/Bundle_Of_Vines )	return /obj/item/tool/Fishing_Net
			...
			if ( /obj/item/tool/Knife )
				switch (obj2.type)
					if ( /obj/item/material/Logs )		return /obj/item/misc/Canoe
//			if ( /obj/item/material/Logs )
//				switch (obj2.type)
//					if ( /obj/item/material/Logs)		return /obj/item/misc/Many_Logs
			...
			if ( /obj/item/misc/Twine )
				...
				if ( obj2.type == /obj/item/misc/Twine )	return /obj/item/misc/Fabric
