...
datum/oreFind
	...
	Zinc
		...
		minSkill = 7
	Titanium
		ore = /obj/item/ore/Titanium_Ore
		minSkill = 10
	Adamantium
		ore = /obj/item/ore/Adamantium_Ore
		minSkill = 16
	Silver
		ore = /obj/item/ore/Silver_Ore
		minSkill = 8
	Gold
		ore = /obj/item/ore/Gold_Ore
		minSkill = 11
...
//		smeltSkill = 7
		GetSmeltResult(obj/item/ore/other)
			if ( !other )
				return /obj/item/ingot/Titanium
	Adamantium_Ore
...
//		smeltSkill = 7
		GetSmeltResult(obj/item/ore/other)
			if ( !other )
				return /obj/item/ingot/Adamantium
	Silver_Ore
		icon_state = "silver"
		weight = 4
//		smeltSkill = 7
