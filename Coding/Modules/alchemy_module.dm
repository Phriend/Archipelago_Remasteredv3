...
obj/item/tool/Mortar_And_Pestle/proc/getGrindChance(obj/item/food/food,mob/player/grinder)
...
obj/item/tool/Mortar_And_Pestle/proc/getGrindXP(obj/item/food/food)
...
obj/item/powder
	...
	New(loc,obj/item/food/food)
		...
		AdjustIconColor(newIcon,food.colour)
		icon = newIcon
		..()
...
obj/item/tool/Mortar_And_Pestle/proc/Grind(obj/item/food,mob/player/grinder)
	...
	if ( prob(chance) )
		...
		gameMessage(grinder,"The pestle slips and you lose the [food].",MESSAGE_ALCHEMY)
...
obj/item/food/plant/MouseDrop(obj/item/tool/Mortar_And_Pestle/mortar)
	if ( !mortar || !istype(mortar,/obj/item/tool/Mortar_And_Pestle) )
		return ..()
